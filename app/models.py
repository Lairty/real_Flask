...
class Post(db.Model):
    ...
    otr = db.Column(db.Integer)
    n = db.Column(db.Integer)
    oporos = db.Column(db.Integer)
    cityZ = db.Column(db.Integer)
...
class Feedback(db.Model):
    ...
    str = db.Column(db.String(140))
    timestamp = db.Column(db.DateTime, index=True, default=datetime.utcnow)
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'))
    costCl = db.Column(db.Integer)
    costCh = db.Column(db.Integer)
    costA = db.Column(db.Integer)
